...
def cosin(tensor1, tensor2):
    ...
    cosine_similarity = F.cosine_similarity(tensor1_flat.unsqueeze(0).to(torch.float32), tensor2_flat.unsqueeze(0).to(torch.float32))
...
def compare(path1, path2):
    ...
    assert lhs_tensor_num == rhs_tensor_num, "lhs and rhs tensor number not equal, {} vs {}.".format(lhs_tensor_num, rhs_tensor_num)
